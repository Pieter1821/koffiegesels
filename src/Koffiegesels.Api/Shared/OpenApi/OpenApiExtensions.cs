...
namespace Koffiegesels.Api.Shared.OpenApi;

public static class OpenApiExtensions
{
    public static IHostApplicationBuilder AddKoffiegeselsOpenApi(this IHostApplicationBuilder builder)
    {
    ...
    public static WebApplication UseKoffiegeselsSwaggerUI(this WebApplication app)
    {
        app.MapOpenApi();
        ...
        {
            options.SwaggerEndpoint("/openapi/v1.json", "Koffiegesels API v1");
...
internal sealed class OAuthSecurityDocumentTransformer(IOptions<AuthOptions> authOptions) : IOpenApiDocumentTransformer
{
    public Task TransformAsync(OpenApiDocument document, OpenApiDocumentTransformerContext context, CancellationToken cancellationToken)
    {
        ...
        document.Info.Title = "Koffiegesels API";
        ...
        document.Components.SecuritySchemes["oauth2"] = new OpenApiSecurityScheme
        {
            ...
            Flows = new OpenApiOAuthFlows
            {
                AuthorizationCode = new OpenApiOAuthFlow
                {
                    ...
                    {
                        [opts.ApiScope] = "Access to Koffiegesels protected endpoints"
                    }
                }
            }
        };
